...
export function notificationBody(phase:string){return phase==='pending'?'Une demande attend votre validation dans FarmPilot.':phase==='approuvee'?'Votre demande a été approuvée. Consultez FarmPilot.':phase==='rejetee'?'Votre demande a été refusée. Consultez le motif dans FarmPilot.':'Le statut de votre demande a changé. Consultez FarmPilot.'}

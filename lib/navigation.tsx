...
import {
  ...
  // Section icons
  Compass,
  Sprout as SectionSprout,
  Building2 as SectionBuilding,
  Handshake as SectionHandshake,
  ShoppingCart as SectionShopping,
  Wallet as SectionWallet,
  Users as SectionUsers,
  Sliders,
  ShieldAlert,
  BookOpen as SectionBook,
  // Nav items
  LayoutDashboard,
  Sprout,
  Settings2,
...
export const NAV: NavSection[] = [
    ...
    items: [
      {
        ...
        color: "#6366f1",
        keywords: ["accueil", "home", "kpi", "tableau de bord"],
        shortcut: ["g", "d"],
      ...
      },
      {
        ...
        icon: ShieldCheck,
        color: "#166534",
        keywords: ["mobile", "approbation", "responsable", "notifications"],
      },
      {
        href: "/alertes",
        moduleCode: "alertes",
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      {
        href: "/plan-culture",
        moduleCode: "campagnes",
        label: "Plan de culture",
        icon: Leaf,
        color: "#10b981",
        keywords: ["plan", "budget", "volumes", "gantt", "planification"],
        description: "Vue Gantt + KPI plantations",
      },
      {
        href: "/campagnes",
        moduleCode: "campagnes",
        ...
        icon: Calendar,
        color: "#22c55e",
        keywords: ["saison", "cycle"],
        description: "Saisons de production",
      },
      {
        href: "/production",
        ...
        icon: Settings2,
        color: "#f59e0b",
        keywords: ["rendement", "plantations", "production"],
        description: "Affectation variétés × serres",
      },
      {
        href: "/recoltes",
        moduleCode: "recoltes",
        ...
        icon: Sprout,
        color: "#10b981",
        keywords: ["harvest", "lots", "tri", "station", "recolte"],
        shortcut: ["g", "r"],
        description: "Lots, tri, dispatches, prix",
      },
      {
        href: "/pointage",
        moduleCode: "pointage",
        ...
        description: "Heures de travail par serre/tâche",
      },
      {
        href: "/productivite",
        moduleCode: "productivite",
        label: "Productivité",
        icon: Gauge,
        color: "#8b5cf6",
        keywords: [
    ...
    items: [
      {
        ...
        moduleCode: "agronomie",
        label: "Prescriptions et traitements",
        icon: ClipboardList,
        color: "#0d9488",
        keywords: ["phyto", "prescription", "traitement", "planification", "application"],
        description: "Planifier, valider et confirmer les traitements",
      },
      {
        href: "/agronomie/produits",
        moduleCode: "agronomie",
        label: "Produits phytosanitaires",
        icon: FlaskConical,
        color: "#0d9488",
        keywords: ["phyto", "onssa", "pesticide", "fongicide", "insecticide"],
        description: "Produits homologués et usages autorisés",
      },
      {
        href: "/agronomie/cibles",
        moduleCode: "agronomie",
        label: "Cibles biologiques",
        icon: Crosshair,
        color: "#84cc16",
        keywords: ["cibles", "ravageurs", "maladies", "alias", "phyto"],

        description: "Référentiel des ravageurs, maladies et cibles",
      },
      {
        href: "/agronomie/produits/import",
        moduleCode: "agronomie",
        label: "Importer liste positive",
        icon: Upload,
        color: "#0d9488",
        keywords: ["phyto", "liste positive", "pdf", "excel"],
        description: "Importer et comparer les versions reçues",
      },
      {
        href: "/agronomie/produits/listes",
        moduleCode: "agronomie",
        label: "Listes positives",
        icon: ListChecks,
        color: "#10b981",
        keywords: ["phyto", "contrôle", "versions", "historique", "salad time"],
        description: "Contrôler, comparer et activer les listes importées",
      },
      {
        href: "/agronomie/produits/conformite",
        moduleCode: "agronomie",
        label: "Conformité marchés & LMR",
        icon: ShieldCheck,
        color: "#f59e0b",
        keywords: ["phyto", "LMR", "marché", "client", "export"],
        description: "Règles ONSSA, clients et destinations",
      },
      {
        href: "/stocks/preparation-phyto",
        moduleCode: "stocks",
        label: "Préparer les articles de stock",
        icon: Package,
        color: "#0d9488",
        keywords: ["phyto", "stock", "articles", "liste positive", "préparation"],
        description: "Préparer les articles de stock depuis les listes positives",
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Box,
        color: "#0ea5e9",
        keywords: ["greenhouse", "tunnel"],
        description: "Inventaire des serres",
      },
      {
        href: "/cultures",
        moduleCode: "varietes",
        ...
        description: "Cultures de l'exploitation + catalogue de variétés",
      },
      {
        href: "/varietes",
        moduleCode: "varietes",
        ...
        icon: Dna,
        color: "#a855f7",
        keywords: ["cultivar", "roma", "cherry", "tomate"],
        description: "Catalogue des variétés",
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Globe,
        color: "#3b82f6",
        keywords: ["export", "local", "prix"],
        description: "Débouchés (export, local…)",
      },
      {
        href: "/commandes",
      ...
      },
      {
        ...
        icon: Receipt,
        color: "#f43f5e",
        keywords: ["invoice", "facture", "paiement", "echeance", "tresorerie"],
        description: "Factures + échéances",
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      {
        href: "/fournisseurs",
        moduleCode: "fournisseurs",
        label: "Fournisseurs",
        icon: Truck,
        color: "#f97316",
        keywords: ["suppliers"],
        description: "Annuaire fournisseurs",
      },
      {
        href: "/achats",
        moduleCode: "achats",
      ...
      },
      {
        ...
        icon: Package,
        color: "#14b8a6",
        keywords: ["inventory", "magasin", "inventaire"],
        description: "Inventaire + mouvements",
      },
      {
        href: "/entrepots",
        moduleCode: "stocks",
        ...
        icon: Building2,
        color: "#0ea5e9",
        keywords: ["entrepot", "dépôt", "magasin", "transfert"],
        description: "Référentiel des entrepôts",
      },
      {
        ...
        icon: Truck,
        color: "#0ea5e9",
        keywords: ["entrepôt", "expédition", "réception", "transit"],
    ...
    items: [
      {
        ...
        icon: Briefcase,
        color: "#8b5cf6",
        keywords: ["budget", "previsions"],
        description: "Budgets prévisionnels par version",
      },
      {
        href: "/couts",
        moduleCode: "couts",
        ...
        icon: Coins,
        color: "#f59e0b",
        keywords: ["charges", "cout", "depenses"],
        description: "Saisie des coûts réels",
      },
      {
        href: "/couts/pilotage", moduleCode: "couts", label: "Coûts/kg et valorisation",
        icon: Calculator, color: "#14b8a6", keywords: ["cump", "stock", "serre", "cout", "kg"],
      ...
      },
      {
        ...
        icon: Calculator,
        color: "#a855f7",
        keywords: ["immo", "amort", "actifs"],
        description: "Actifs immobilisés",
      },
      {
        href: "/admin/compte-exploitation",
        moduleCode: "compte_exploitation",
        label: "Compte d'exploitation",
        icon: FileBarChart,
        color: "#10b981",
        keywords: ["cpc", "rapport", "budget", "reel"],
        description: "Budget vs Réel par catégorie",
      },
      {
        href: "/marges",
        moduleCode: "marges",
        ...
        icon: TrendingUp,
        color: "#10b981",
        keywords: ["rentabilite", "profit", "marge brute"],
        description: "Rentabilité par variété/marché",
      },
      {
        href: "/analytique",
        moduleCode: "analytique",
        label: "IA & Analyses",
        icon: Bot,
        color: "#8b5cf6",
        keywords: ["ai", "gemini", "prediction", "analytics", "previsions"],
        description: "Diagnostics & prévisions IA",
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: Users,
        color: "#0ea5e9",
        keywords: ["hr", "rh dashboard"],
        description: "Vue d'ensemble RH",
      },
      {
        href: "/rh/employes",
        moduleCode: "rh_employes",
        label: "Employés",
        icon: UserSquare,
        color: "#0ea5e9",
        keywords: ["salaries", "tacheron", "fermier", "staff"],
        description: "Annuaire employés + matricule auto",
      },
      {
        href: "/rh/paie",
        moduleCode: "rh_paie",
        ...
        icon: Banknote,
        color: "#10b981",
        keywords: ["payroll", "salaire", "bulletin"],
        description: "Bulletins mensuel/quinzaine",
      },
      {
        href: "/rh/conges",
        moduleCode: "rh_conges",
        label: "Congés",
        icon: Palmtree,
        color: "#f59e0b",
        keywords: ["vacation", "absences", "maladie"],
      ...
      },
      {
        ...
        icon: Building,
        color: "#6366f1",
        keywords: ["cnss", "amo", "cotisations", "damancom"],
        description: "Déclarations CNSS",
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: BookText,
        color: "#0ea5e9",
        keywords: ["categories", "comptable"],
        description: "Catégories comptables",
      },
      {
        ...
        icon: Workflow,
        color: "#64748b",
        keywords: ["states", "transitions"],
        description: "États & transitions",
      },
      {
        ...
        icon: ShieldCheck,
        color: "#8b5cf6",
        keywords: ["approbation", "responsable", "validation"],
        description: "Validations par processus et type",
      },
      {
        href: "/rh/chatbot",
        moduleCode: "rh_chatbot",
        label: "Chatbot Telegram",
        icon: MessageSquare,
        color: "#26a5e4",
        keywords: ["bot", "telegram", "voice", "ouvriers"],
        description: "Saisie vocale par message",
      },
    ],
  },
    ...
    items: [
      {
        ...
        icon: Globe,
        color: "#8b5cf6",
        keywords: ["clients", "sociétés", "domaines", "plateforme"],
        description: "Clients et sociétés FarmPilot",
        platformOnly: true,
      },
      {
        ...
        description: "Identité du domaine, campagne live, options d'affichage",
      },
      {
        ...
        description:
          "Listes déroulantes paramétrables (types, catégories, unités) sans code",
      },
      {
        href: "/admin/users",
        moduleCode: "users",
      ...
      },
      {
        ...
        icon: ShieldCheck,
        color: "#ef4444",
        description: "Rôles & matrice de permissions",
      },
      {
        href: "/admin/demo-reset",
        moduleCode: "users",
        label: "Démo / Reset",
        icon: Database,
        color: "#ef4444",
        ...
        description: "Nouvelle campagne, suppression et reset (démo)",
      },
    ],
  },
...
export const QUICK_ACTIONS: QuickAction[] = [
  {
    ...
    icon: Sprout,
    color: "#10b981",
    keywords: ["ajouter", "créer", "récolte"],
    moduleCode: "recoltes",
  },
  {
    id: "new-campaign",
    ...
    icon: Calendar,
    color: "#22c55e",
    keywords: ["créer", "campagne"],
    moduleCode: "campagnes",
  },
  {
    id: "new-greenhouse",
    label: "Nouvelle serre",
    href: "/serres",
    icon: Box,
    color: "#0ea5e9",
    keywords: ["créer", "serre"],
    moduleCode: "serres",
  },
  {
    id: "new-employee",
  ...
  {
    id: "new-purchase",
    label: "Nouveau bon d'achat",
    href: "/achats",
    icon: ShoppingCart,
    color: "#eab308",
    keywords: ["créer", "achat"],
    moduleCode: "achats",
  },
  {
    id: "view-alerts",

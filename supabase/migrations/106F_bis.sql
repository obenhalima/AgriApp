-- 106F_bis — Script complet remplaçant 106F. Exécuter en entier dans une nouvelle requête.
-- Objectif : enregistrer le lien catalogue phyto et réparer les articles générés sans lien.
BEGIN;
